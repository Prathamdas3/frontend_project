  ...
  return (
    ...
    <section className="grid grid-rows-2 min-h-screen dark:bg-dark_price_component_background">
      ...
      <div className=" flex justify-center items-center bg-price_component_background dark:bg-dark_price_component_background">
        <div className="h-[55%] shadow-lg grid grid-row-2 rounded-lg w-[90%]  md:w-[28%] md:h-[45%] border-2 border-gray-50 dark:border-gray-700 absolute  bottom-[4.5rem] md:bottom-40 bg-price_component_background dark:bg-dark_price_component_background">
        <div className='lg:px-10 flex flex-col itmes-center justify-center gap-10'>
          <div className="text-text_text text-sm flex flex-col lg:flex-row items-center justify-between gap-y-7 lg:gap-y-0 dark:text-dark_text_text">
          ...
          <div className="text-xs flex items-center text-text_text justify-center mb-6 md:mb-0 dark:text-dark_text_text">
            ...
            <span className="text-nowrap font-bold sm:block hidden ml-2 text-xs dark:bg-dark_discount_background dark:text-dark_discount_text bg-discount_background text-discount_text px-2 py-1 rounded-full">25% discount</span>
           
            <span className="sm:hidden block ml-2 tracking-tighter dark:bg-dark_discount_background dark:text-dark_discount_text bg-discount_background text-discount_text px-2 py-0.5 rounded-full text-[10px] font-bold">
              -25%
            </span>
          </div>
          </div>
